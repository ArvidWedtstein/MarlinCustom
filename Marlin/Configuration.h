...
#define STRING_CONFIG_H_AUTHOR "(ArvidWedtstein, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Arvid"
 ...
 */
//#define Z_MIN_PROBE_PIN Pin PC14 // Pin 32 is the RAMPS default // PC14
 ...
 *
 * IMPORTANT: Runout will only trigger if Marlin is aware that a print job is running.t
