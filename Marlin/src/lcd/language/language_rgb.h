...
namespace Language_en {
  ...
  LSTR LANGUAGE                           = _UxGT("RGBish");

  // These strings should be translated
  LSTR WELCOME_MSG                        = MACHINE_NAME _UxGT(" rgb.");
  LSTR MSG_YES                            = _UxGT("RGB");
  LSTR MSG_NO                             = _UxGT("NONRGB");
  ...
  LSTR MSG_MEDIA_WAITING                  = _UxGT("Waiting for rgbism");
  LSTR MSG_SD_INIT_FAIL                   = _UxGT("RGBism Init Fail");
  LSTR MSG_MEDIA_READ_ERROR               = MEDIA_TYPE_EN _UxGT(" read error");
  LSTR MSG_MEDIA_USB_REMOVED              = _UxGT("RGBible removed");
  LSTR MSG_MEDIA_USB_FAILED               = _UxGT("RGBible start failed");
  ...
  LSTR MSG_LASER_POWER                    = _UxGT("RGBism Power");
  ...
  LSTR MSG_LED_CONTROL                    = _UxGT("RGB Control");
  ...
  LSTR MSG_STORE_EEPROM                   = _UxGT("Store RGBible");
  LSTR MSG_LOAD_EEPROM                    = _UxGT("Load RGBible");
  LSTR MSG_RESTORE_DEFAULTS               = _UxGT("Restore RGBism");
  ...
  LSTR MSG_INFO_SCREEN                    = _UxGT("RGB Screen");
  ...
  LSTR MSG_PRINTING                       = _UxGT("Shining rgb colors...");
  LSTR MSG_PRINT_ABORTED                  = _UxGT("Print Aborted");
  LSTR MSG_PRINT_DONE                     = _UxGT("Your print is Done");
  ...
  LSTR MSG_FILAMENTCHANGE                 = _UxGT("Change Color");
  LSTR MSG_FILAMENTCHANGE_E               = _UxGT("Change Color *");
  LSTR MSG_FILAMENTLOAD                   = _UxGT("Load RGBible");
  LSTR MSG_FILAMENTLOAD_E                 = _UxGT("Load *");
  LSTR MSG_FILAMENTUNLOAD                 = _UxGT("Unload RGBible");
  ...
  LSTR MSG_INFO_PSU                       = _UxGT("Power Souply");
